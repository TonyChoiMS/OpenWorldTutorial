...
#include "TCGameSettingWidget.generated.h"

/**
 * Widget that encapsulates a console variable to represent a setting
 */
UCLASS(abstract)
class TCGAMESETTINGMODULE_API UTCGameSettingWidget : public UUserWidget
{
	GENERATED_BODY()

public:
	UTCGameSettingWidget(const FObjectInitializer& ObjectInitializer);
