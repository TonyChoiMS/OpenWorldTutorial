// Copyright TonyChoi. All Rights Reserved.
...
struct TCGAMESETTINGSINPUT_API FConfigActionKeyMapping : public FInputActionKeyMapping
{
	GENERATED_BODY()
	...
	/**
	 * True if this mapping was using the default key from the base preset at the time is was saved
	 * this allow us to keep it in sync if the default mapping is changed
	 */
	 UPROPERTY()
	 ...
	 {
		 return FString::Printf(TEXT("ActionName : %s, Key : %s, bShift: %i, bAlt: %i, bCmd: %i, bIsDefault: %i"),
			 *ActionName.ToString(),
			 *Key.ToString(),
			 (int32)bShift,
			 (int32)bCtrl,
...
USTRUCT(BlueprintType)
struct TCGAMESETTINGSINPUT_API FConfigAxisKeyMapping : public FInputAxisKeyMapping
{
	GENERATED_BODY()
