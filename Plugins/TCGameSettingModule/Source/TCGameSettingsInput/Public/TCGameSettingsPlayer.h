...
#include "TCGameSettingsPlayer.generated.h"

UINTERFACE(MinimalAPI)
class UTCGameSettingsPlayer : public UInterface
{
	GENERATED_BODY()
};

/**
 * Interface for GameSettings to interact with a PlayerController
 */
class TCGAMESETTINGSINPUT_API ITCGameSettingsPlayer
{
	GENERATED_BODY()
