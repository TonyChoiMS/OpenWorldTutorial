...
*/
UCLASS(Config = Input)
class TCGAMESETTINGSINPUT_API UInputMappingManager : public UObject
{
	GENERATED_BODY()
...
public:
	...
	// Get input presets defined in project settings
	...
	// Presets and tags are defined in project settings
	// Static version
	...
	static const UTCGameSettingsInputConfig* GetInputConfigStatic();
	...
	const UTCGameSettingsInputConfig* GetInputConfig() const;
