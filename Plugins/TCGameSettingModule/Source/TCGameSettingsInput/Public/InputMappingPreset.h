...
struct TCGAMESETTINGSINPUT_API FInputMappingPreset
{
	GENERATED_BODY()
	...
	FInputMappingPreset(FGameplayTag InTag, bool InUseDefaultMappings, TWeakInterfacePtr<const ITCGameSettingsInputConfigInterface> InConfig)
	{
		PresetTag = InTag;
