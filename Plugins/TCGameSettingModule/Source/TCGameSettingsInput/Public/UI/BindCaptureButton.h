 ...
 */
UCLASS(abstract)
class TCGAMESETTINGSINPUT_API UBindCaptureButton : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	// Key groups can be defined in project settings
	UPROPERTY()
	...
	// Create prompt and start listeneing for input chord
...
protected:
	...
	// Called to initalize a new prompt widget to listen for input capture
