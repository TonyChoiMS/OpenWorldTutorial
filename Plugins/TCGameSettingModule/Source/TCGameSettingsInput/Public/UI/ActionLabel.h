...
UCLASS(abstract)
class TCGAMESETTINGSINPUT_API UActionLabel : public UInputLabel
{
	GENERATED_BODY()
...
private:
	...
	void SetModifierKeyLabelVisibility(UKeyLabel* KeyLabel, UWidget* KeySeparator, bool bVisibility);
