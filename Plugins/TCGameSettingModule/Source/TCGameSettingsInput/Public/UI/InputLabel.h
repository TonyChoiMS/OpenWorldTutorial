 ...
 */
UCLASS(abstract)
class TCGAMESETTINGSINPUT_API UInputLabel : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "InputLabel")
	int32 MappingGroup;
	...
	// Key icons and tags can be defined in project settings
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input Label")
